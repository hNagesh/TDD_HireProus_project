...
public class Portfolio_CTC_02_FeatureTest extends BaseClass {
	...
	public void Portfolio_CTC_02_Feature() throws IOException {

		TestCaseName = Thread.currentThread().getStackTrace()[1].getMethodName();

		StartTest(TestCaseName,"Meet Thresholds for Organic Gases custom scenarios");
