...
public class TC_02_RegisterMembershipTest extends BaseClass {

	@Test(dependsOnMethods = { "com.Well.testcases.login.TC_01_LoginTest.TC_01_Login" })
	@Parameters({ "SheetName","rowNum","MembershipName" })
	public void TC_02_RegisterMembership(String SheetName,int rowNum, String MembershipName) throws IOException {
