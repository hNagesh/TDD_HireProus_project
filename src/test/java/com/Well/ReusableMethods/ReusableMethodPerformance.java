...
public class ReusableMethodPerformance extends BaseClass {
	...
	public void uploadDocumentInFeature(int LastFeatureNumber) throws IOException, InterruptedException {
		...
		for (WebElement f : Feature) {
			...
			CommonMethod.WaitUntilPresence("WPRVerficationTab", 120);
			CommonMethod.RobustclickElementVisible("WPRVerficationTab","WPRAddOption");
			CommonMethod.WaitUntilPresence("WPRAddOption", 60);
			CommonMethod.Robustclick("WPRAddOption","WPRAddOptionbtn");
			CommonMethod.WaitUntilPresence("WPRAddOptionbtn", 60);
			...
			Thread.sleep(1000);
			CommonMethod.RobustclickElementVisible("WPRAssignLocbtn","WPRAssignLocFirstChildCbx");
			...
			CommonMethod.WaitUntilPresence("WPRUploadDocTaskbtn", 60);
